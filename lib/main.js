...
* @returns {boolean} boolean indicating whether two half-precision floating-point numbers are approximately the same value within a specified number of ULPs
*
* @example
